...
public class speedtest {
    ...
    public static void prog()throws IOException{
        ...
        System.out.println("4 - Update (All data once)");
        System.out.println("5 - Update (Select what to update)");
        ...
        switch(choice){
            ...
            case 4:{
                ...
                in.nextLine();
                String toUpdate = in.nextLine().toLowerCase();
            ...
            case 5:{
                    ...
                    do {
                        ...
                        File inputFile = new File("Student Records - P.txt");
